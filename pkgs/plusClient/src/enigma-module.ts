import type {
  EnigmaModule,
  ModuleWebSocketContext,
  ModuleWebSocketHandlers,
  ModuleWebSocketControls,
} from "@nightnetwork/enigma";
  ...
  const module: EnigmaModule = {
    ...
    hooks: {
      ...
      provideMeta: () => ({
        ...
        description:
          "Injects Night-Auth session tokens into WebSocket connections via protocol",
        version: "1.0.0",
        enabled: true,
      }),
    },
